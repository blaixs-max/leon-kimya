...
window.SITE_BASE = {
  ...
  nav: [
    ...
    { k:"products", href:"#urunler", mega:true, children:[
      { k:"adhesives", L:"parke", children:[
        ...
        { k:"rubberTurfAdh", L:"kaucuk" }, { k:"filterAdh", L:"filtre" } ] },
  ...
  details: {
    ...
    "parke": {"nav": "parquetAdh", "img": "assets/img/cat-parquet-v2.jpg", "gallery": ["assets/img/vid-parquet-v2.jpg", "assets/img/app-parquet-v2.jpg", "assets/img/tile-parquet-v2.jpg"], "productImgs": ["assets/img/prod-parke-01.jpg", "assets/img/prod-parke-02-v2.jpg", "assets/img/prod-parke-03.jpg"]},
    "pvc": {"nav": "pvcAdh", "img": "assets/img/pvc-apply.jpg", "gallery": ["assets/img/pvc-hall.jpg"], "productImgs": ["assets/img/prod-pvc-01-v2.jpg"]},
    ...
    "filtre": {"nav": "filterAdh", "img": "assets/img/ind-machines.jpg", "gallery": [], "productImgs": ["assets/img/prod-filtre-01-v2.jpg", "assets/img/prod-filtre-02-v2.jpg", "assets/img/prod-filtre-02-v2.jpg"]},
    "dokme": {"nav": "pourBinder", "img": "assets/img/cat-binder-v2.jpg", "gallery": ["assets/img/epdm-insitu.jpg", "assets/img/tile-binder-v2.jpg", "assets/img/app-playground-v2.jpg"], "productImgs": ["assets/img/prod-binder-01-v3.jpg", "assets/img/prod-binder-01-v3.jpg", "assets/img/prod-binder-02-v3.jpg"]},
    "press": {"nav": "pressBinder", "img": "assets/img/rubber-tiles.jpg", "gallery": ["assets/img/app-rubber-v2.jpg", "assets/img/sport-gym.jpg"], "productImgs": ["assets/img/prod-binder-01-v3.jpg", "assets/img/prod-binder-02-v3.jpg", "assets/img/rubber-tiles.jpg", "assets/img/app-rubber-v2.jpg"]},
    "tas": {"nav": "stoneBinder", "img": "assets/img/app-stone-v2.jpg", "gallery": ["assets/img/stone-sample.jpg"], "productImgs": ["assets/img/prod-tas-01-v2.jpg", "assets/img/prod-tas-02-v2.jpg", "assets/img/prod-binder-02-v3.jpg"]},
    ...
    "puZemin": {"nav": "puCoat", "img": "assets/img/cat-coating-v2.jpg", "gallery": ["assets/img/ind-service.jpg", "assets/img/tile-sport-v2.jpg", "assets/img/ind-apply.jpg"], "productImgs": ["assets/img/prod-pu-01-v2.jpg", "assets/img/prod-pu-02-v2.jpg", "assets/img/prod-pu-03-v2.jpg"]},
    "akZemin": {"nav": "acCoat", "img": "assets/img/sport-tennis.jpg", "gallery": ["assets/img/sport-tennis2.jpg"], "productImgs": ["assets/img/prod-ak-01-v2.jpg", "assets/img/prod-ak-02-v2.jpg", "assets/img/prod-ak-02-v2.jpg", "assets/img/prod-ak-03-v2.jpg", "assets/img/prod-ak-04-v2.jpg", "assets/img/prod-ak-05-v2.jpg", "assets/img/prod-ak-06-v2.jpg", "assets/img/prod-ak-06-v2.jpg", "assets/img/prod-ak-07.jpg", "assets/img/prod-ak-08.jpg", "assets/img/prod-ak-09.jpg"]},
    "epZemin": {"nav": "epCoat", "img": "assets/img/ind-apply.jpg", "gallery": ["assets/img/ind-texture.jpg", "assets/img/ind-roller.jpg", "assets/img/tile-industrial-v2.jpg", "assets/img/resin-wave.jpg"], "productImgs": ["assets/img/prod-ep-01-v2.jpg", "assets/img/tile-industrial-v2.jpg", "assets/img/prod-ep-02-v2.jpg"]},
    "astar": {"nav": "primers", "img": "assets/img/cat-primer-v2.jpg", "gallery": ["assets/img/ind-apply.jpg"], "productImgs": ["assets/img/cat-primer-v2.jpg", "assets/img/prod-ak-07.jpg", "assets/img/ind-apply.jpg", "assets/img/prod-astar-01-v2.jpg", "assets/img/prod-astar-01-v2.jpg", "assets/img/prod-astar-01-v2.jpg"]},
...
tr: {
  ...
  nav:{
    ...
    filterAdh:"Filtre Yapıştırıcıları",
  ...
  details:{
    ...
    dokme:{ lead:"SBR ve EPDM granülleri sahada tek parça, esnek bir zemine dönüştüren; nemle kürlenen tek komponentli poliüretan prepolimerler.",
      ...
      props:[],
      products:[{"t": "EPDM Dökme Bağlayıcı", "d": "Renkli EPDM granül sistemlerinde ton bütünlüğü sağlayan pigmentli bağlayıcı."}, {"t": "SBR Dökme Bağlayıcı", "d": "Siyah SBR ve koyu renkli sistemler için standart wet-pour bağlayıcısı."}, {"t": "Alifatik EPDM Bağlayıcı (UV Dayanımlı)", "d": "Renkli EPDM yüzeylerde sararma yapmayan, UV kararlı premium tip."}] },
    ...
    suUrun:{ lead:"Çatıdan temele her detay için likit membranlar ve tamamlayıcı astarlardan oluşan eksiksiz su yalıtım portföyü.",
      paras:["UV'ye açık son katlar için alifatik, kaplama altı için ekonomik tipler; düşey yüzeyler için akmayan (tiksotropik) ve bitüm-poliüretan melez varyantlar sunulur. Emici ve emici olmayan yüzeyler için ayrı astarlar sistemi tamamlar."],
...
en: {
  ...
  details:{
    ...
    dokme:{ lead:"Moisture-curing, one-component polyurethane prepolymers that turn SBR and EPDM granules into a monolithic, flexible floor on site.",
      ...
      props:[],
      products:[{"t": "EPDM Pour Binder", "d": "A pigmented binder preserving colour consistency in coloured EPDM granule systems."}, {"t": "SBR Pour Binder", "d": "The standard wet-pour binder for black SBR and dark systems."}, {"t": "Aliphatic EPDM Binder (UV-Stable)", "d": "A premium non-yellowing grade for coloured EPDM surfaces."}] },
    ...
    suUrun:{ lead:"A complete waterproofing portfolio of liquid membranes and matching primers for every detail from roof to foundation.",
      paras:["Aliphatic grades serve UV-exposed finish coats and economical grades go under tiling; non-sag (thixotropic) types handle vertical surfaces and bitumen-polyurethane hybrids extend the range. Separate primers for absorbent and non-absorbent substrates complete the system."],
...
fr: {
  ...
  nav:{
    ...
    filterAdh:"Adhésifs pour filtres",
  ...
  details:{
    ...
    dokme:{ lead:"Prépolymères polyuréthane monocomposants réticulant à l'humidité, qui transforment sur site les granulés SBR et EPDM en un sol souple monolithique.",
      ...
      props:[],
      products:[{"t": "Liant coulé EPDM", "d": "Liant pigmenté préservant la cohérence des couleurs dans les systèmes EPDM colorés."}, {"t": "Liant coulé SBR", "d": "Le liant wet-pour standard pour SBR noir et systèmes foncés."}, {"t": "Liant EPDM aliphatique (UV)", "d": "Grade premium non jaunissant pour surfaces EPDM colorées."}] },
    ...
    suUrun:{ lead:"Un portefeuille d'étanchéité complet — membranes liquides et primaires adaptés — pour chaque détail, du toit aux fondations.",
      paras:["Grades aliphatiques pour les finitions exposées aux UV, grades économiques sous carrelage ; types non coulants (thixotropes) pour les surfaces verticales et hybrides bitume-polyuréthane en complément. Des primaires distincts pour supports absorbants et non absorbants complètent le système."],
...
ar: {
  ...
  details:{
    ...
    filtre:{ lead:"أنظمة بولي يوريثان صناعية تمسك وسيط الترشيح والإطار والأغطية معًا — وتشكّل حشوات إحكام في مكانها عند الحاجة.",
      paras:["مهمتان مختلفتان تلبيهما عائلتان مختلفتان: تثبيت الوسيط يستهدف رابطة قوية قابلة للتكرار، بينما منتجات الحشوات تقدّم ملءًا محكومًا وثبات شكل وإحكامًا. تتوفر درجات سريعة التصلب وغير سائلة (ثيكسوتروبية) لخطوط الجرعات الآلية.", "طريقة الجرعة واللزوجة وزمن العمل ودرجة حرارة التشغيل والسائل الملامس تحدّد الاختيار. عند تغيّر الوسيط أو الإطار أو دفعة المواد، يُنصح بتجربة صغيرة قبل الإنتاج التسلسلي."],
      areas:["فلاتر الهواء", "فلاتر السيارات", "خراطيش الترشيح الصناعية", "حشوات الفلاتر", "خطوط الجرعات الآلية"],
      props:[],
      products:[{"t": "لاصق فلاتر سريع التصلب", "d": "نظام بولي يوريثان مطوّر لدورات قصيرة في خطوط الجرعات الآلية."}, {"t": "لاصق فلاتر للجرعات الآلية", "d": "درجة توفر ثبات جرعات قابلًا للتكرار في خطوط الإنتاج."}, {"t": "درجة ثيكسوتروبية / حشوات", "d": "درجة غير سائلة تشكّل الحشوات في مكانها بثبات شكل عالٍ."}] },
    dokme:{ lead:"بريبوليمرات بولي يوريثان أحادية المكوّن تتصلّب بالرطوبة، تحوّل حبيبات SBR وEPDM في الموقع إلى أرضية مرنة متجانسة.",
      ...
      props:[],
      products:[{"t": "رابط صب EPDM", "d": "رابط مصبوغ يحافظ على اتساق الألوان في أنظمة حبيبات EPDM الملوّنة."}, {"t": "رابط صب SBR", "d": "رابط wet-pour القياسي للـSBR الأسود والأنظمة الداكنة."}, {"t": "رابط EPDM أليفاتي (مقاوم للأشعة)", "d": "درجة مميزة لا تصفرّ لأسطح EPDM الملوّنة."}] },
    ...
    suUrun:{ lead:"محفظة عزل مائي كاملة من الأغشية السائلة والبرايمرات المناسبة، لكل تفصيل من السطح حتى الأساسات.",
      paras:["درجات أليفاتية للطبقات النهائية المعرّضة للأشعة ودرجات اقتصادية تحت التبليط؛ وأنواع غير سائلة (ثيكسوتروبية) للأسطح الرأسية ومتغيرات هجينة من البيتومين والبولي يوريثان. وتكتمل المنظومة ببرايمرات منفصلة للأسطح الماصّة وغير الماصّة."],
